...
const CodeSnippetDisplay: React.FC<CodeSnippetDisplayProps> = ({ code, codeExampleLabel, copyLabel, copiedLabel }) => {
  ...
  return (
    <div className="mt-4 pt-4 border-t border-ink/10">
      <div className="flex justify-between items-center mb-2">
        <span className="font-mono text-xs font-bold uppercase tracking-widest text-ink/50 block">{codeExampleLabel}</span>
        <button 
          onClick={handleCopy}
