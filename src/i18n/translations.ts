...
const english: TranslationSet = {
  ...
  dashboard: {
    ...
    solutionLocked: 'Solution locked', lockedHint: 'Unlock a copy-paste AI agent prompt that fixes only this issue — nothing else.', unlockCta: 'Unlock – €10.99',
    codeExample: 'AI agent prompt', copyCode: 'Copy for AI', copied: 'Copied!',
...
localized.sv.dashboard = { ...localized.sv.dashboard, solutionLocked: 'Lösning låst', lockedHint: 'Lås upp en copy-paste AI-agentprompt som bara fixar just det här problemet — inget annat.', unlockCta: 'Lås upp – €10,99', codeExample: 'AI-agentprompt', copyCode: 'Kopiera för AI' };
