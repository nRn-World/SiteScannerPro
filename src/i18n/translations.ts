...
const english: TranslationSet = {
  ...
  dashboard: {
    ...
    codeExample: 'Code example', copyCode: 'Copy code', copied: 'Copied!',
...
localized.sv.dashboard = { ...localized.sv.dashboard, solutionLocked: 'Lösning låst', lockedHint: 'Få exakta åtgärder med steg-för-steg-instruktioner och färdig kod.', unlockCta: 'Lås upp – €10,99' };
