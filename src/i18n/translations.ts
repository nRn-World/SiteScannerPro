import { SiteCopy, siteCopy } from './site';
...
export interface TranslationSet {
  languageName: string;
  nav: { scanner: string; about: string; contact: string; premium: string; pricing: string };
  site: SiteCopy;
  hero: {
    secure: string;
...
const english: TranslationSet = {
  ...
  site: siteCopy.en,
  nav: { scanner: 'Scanner', about: 'About', contact: 'Contact', premium: 'Premium', pricing: 'Pricing' },
  hero: {
...
localized.sv.dashboard = { ...localized.sv.dashboard, solutionLocked: 'Lösning låst', lockedHint: 'Få exakta åtgärder med steg-för-steg-instruktioner och färdig kod.', unlockCta: 'Lås upp – 99 kr' };
