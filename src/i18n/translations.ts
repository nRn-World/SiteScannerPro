...
export interface TranslationSet {
  ...
  scanning: { target: string; coldStartHint: string };
  scanSteps: string[];
  ...
  share: { ready: string; copy: string; copied: string; open: string; compare: string };
  vip: {
    banner: string;
    used: string;
    ownerTitle: string;
...
const english: TranslationSet = {
  ...
  nav: {
    ...
    removePremiumConfirm: 'Remove Premium from this browser? You can activate your Pro code again anytime.'
  },
  hero: {
  ...
  scanning: { target: 'Target:', coldStartHint: 'Deep scans take 20–40 s. If the server is waking up, the first scan may take up to a minute.' },
  scanSteps: [
  ...
  share: {
    ready: 'Share this report (link expires automatically):',
    copy: 'Copy link',
    copied: 'Copied!',
    open: 'Open',
    compare: 'Previous scan of this site:'
  },
  vip: {
...
localized.tr.scanning = { target: 'Hedef:', coldStartHint: 'Derin taramalar 20–40 sn sürer. Sunucu yeni uyandıysa ilk tarama bir dakikaya kadar çıkabilir.' };
...
localized.es.scanning = { target: 'Objetivo:', coldStartHint: 'Los escaneos profundos tardan 20–40 s. Si el servidor acaba de despertar, el primero puede tardar hasta un minuto.' };
...
localized.fr.scanning = { target: 'Cible :', coldStartHint: 'Les analyses approfondies prennent 20 à 40 s. Si le serveur vient de se réveiller, la première peut durer jusqu’à une minute.' };
...
localized.ar.scanning = { target: 'الهدف:', coldStartHint: 'تستغرق الفحوصات العميقة 20–40 ثانية. إذا كان الخادم قد استيقظ للتو فقد يستغرق الفحص الأول حتى دقيقة.' };
...
localized.tr.share = { ready: 'Bu raporu paylaşın (bağlantı otomatik sona erer):', copy: 'Bağlantıyı kopyala', copied: 'Kopyalandı!', open: 'Aç', compare: 'Bu sitenin önceki taraması:' };
localized.tr.scanning = { target: 'Hedef:', coldStartHint: 'Derin taramalar 20–40 sn sürer. Sunucu yeni uyandıysa ilk tarama bir dakikaya kadar çıkabilir.' };
localized.es.share = { ready: 'Comparte este informe (el enlace caduca automáticamente):', copy: 'Copiar enlace', copied: '¡Copiado!', open: 'Abrir', compare: 'Escaneo anterior de este sitio:' };
localized.es.scanning = { target: 'Objetivo:', coldStartHint: 'Los escaneos profundos tardan 20–40 s. Si el servidor acaba de despertar, el primero puede tardar hasta un minuto.' };
localized.fr.share = { ready: 'Partagez ce rapport (le lien expire automatiquement) :', copy: 'Copier le lien', copied: 'Copié !', open: 'Ouvrir', compare: 'Analyse précédente de ce site :' };
localized.fr.scanning = { target: 'Cible :', coldStartHint: 'Les analyses approfondies prennent 20 à 40 s. Si le serveur vient de se réveiller, la première peut durer jusqu’à une minute.' };
localized.ar.share = { ready: 'شارك هذا التقرير (تنتهي صلاحية الرابط تلقائيًا):', copy: 'نسخ الرابط', copied: 'تم النسخ!', open: 'فتح', compare: 'الفحص السابق لهذا الموقع:' };
localized.ar.scanning = { target: 'الهدف:', coldStartHint: 'تستغرق الفحوصات العميقة 20–40 ثانية. إذا كان الخادم قد استيقظ للتو فقد يستغرق الفحص الأول حتى دقيقة.' };
...
localized.sv.share = {
  ready: 'Dela rapporten (länken går ut automatiskt):',
  copy: 'Kopiera länk',
  copied: 'Kopierad!',
  open: 'Öppna',
  compare: 'Föregående skanning av denna sajt:'
};
localized.sv.scanning = { target: 'Mål:', coldStartHint: 'Djupskanningar tar 20–40 s. Om servern precis vaknat kan första skanningen ta upp till en minut.' };
