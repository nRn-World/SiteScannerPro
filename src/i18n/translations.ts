...
const english: TranslationSet = {
  ...
  dashboard: {
    ...
    solutionLocked: 'Solution locked', lockedHint: 'Unlock a compact JSON command for your AI agent that fixes only this issue.', unlockCta: 'Unlock – €10.99',
    codeExample: 'AI JSON command', copyCode: 'Copy JSON', copied: 'Copied!',
  ...
  errors: {
    ...
    vipInvalid: 'This VIP link is invalid or could not be redeemed.',
...
localized.tr.dashboard = { ...english.dashboard, report: 'Analiz raporu', exportPdf: 'PDF olarak dışa aktar', totalScore: 'Toplam puan', details: 'Ayrıntılar gösteriliyor', clickForDetails: 'Ayrıntılar için tıklayın', identifiedIssues: 'Belirlenen sorunlar', categoryIssues: '{category} sorunları', recommendation: 'Öneri', noIssues: 'Bu kategoride sorun bulunamadı.', solutionLocked: 'Çözüm kilitli', lockedHint: 'Yalnızca bu sorunu düzelten kompakt bir JSON komutunun kilidini açın.', unlockCta: 'Kilidi aç – €10,99', codeExample: 'AI JSON komutu', copyCode: 'JSON kopyala', copied: 'Kopyalandı!', severities: { High: 'Yüksek', Medium: 'Orta', Low: 'Düşük' }, categories: { SEO: 'SEO', Performance: 'Performans', Security: 'Güvenlik', Accessibility: 'Erişilebilirlik', Code: 'Kod' } };
localized.es.dashboard = { ...english.dashboard, report: 'Informe de análisis', exportPdf: 'Exportar a PDF', totalScore: 'Puntuación total', details: 'Mostrando detalles', clickForDetails: 'Pulsa para ver detalles', identifiedIssues: 'Problemas identificados', categoryIssues: 'Problemas de {category}', recommendation: 'Recomendación', noIssues: 'No se encontraron problemas en esta categoría.', solutionLocked: 'Solución bloqueada', lockedHint: 'Desbloquea un comando JSON compacto para tu agente de IA que corrige solo este problema.', unlockCta: 'Desbloquear – €10,99', codeExample: 'Comando JSON IA', copyCode: 'Copiar JSON', copied: '¡Copiado!', severities: { High: 'Alta', Medium: 'Media', Low: 'Baja' }, categories: { SEO: 'SEO', Performance: 'Rendimiento', Security: 'Seguridad', Accessibility: 'Accesibilidad', Code: 'Código' } };
localized.fr.dashboard = { ...english.dashboard, report: 'Rapport d’analyse', exportPdf: 'Exporter en PDF', totalScore: 'Score total', details: 'Détails affichés', clickForDetails: 'Cliquer pour les détails', identifiedIssues: 'Problèmes identifiés', categoryIssues: 'Problèmes : {category}', recommendation: 'Recommandation', noIssues: 'Aucun problème dans cette catégorie.', solutionLocked: 'Solution verrouillée', lockedHint: 'Débloquez une commande JSON compacte pour votre agent IA qui corrige uniquement ce problème.', unlockCta: 'Déverrouiller – 10,99 €', codeExample: 'Commande JSON IA', copyCode: 'Copier JSON', copied: 'Copié !', severities: { High: 'Élevée', Medium: 'Moyenne', Low: 'Faible' }, categories: { SEO: 'SEO', Performance: 'Performance', Security: 'Sécurité', Accessibility: 'Accessibilité', Code: 'Code' } };
localized.ar.dashboard = { ...english.dashboard, report: 'تقرير التحليل', exportPdf: 'تصدير PDF', totalScore: 'النتيجة الإجمالية', details: 'عرض التفاصيل', clickForDetails: 'انقر للتفاصيل', identifiedIssues: 'المشكلات المكتشفة', categoryIssues: 'مشكلات {category}', recommendation: 'التوصية', noIssues: 'لم يتم العثور على مشكلات في هذه الفئة.', solutionLocked: 'الحل مقفل', lockedHint: 'افتح أمر JSON مضغوط لوكيل الذكاء الاصطناعي يصلح هذه المشكلة فقط.', unlockCta: 'فتح – €10.99', codeExample: 'أمر JSON للذكاء الاصطناعي', copyCode: 'نسخ JSON', copied: 'تم النسخ!', severities: { High: 'عالية', Medium: 'متوسطة', Low: 'منخفضة' }, categories: { SEO: 'SEO', Performance: 'الأداء', Security: 'الأمان', Accessibility: 'إمكانية الوصول', Code: 'الكود' } };

localized.tr.errors = { freeScan: 'Analiz sırasında bir hata oluştu.', premiumScan: 'Premium analiz başarısız oldu.', scanFailed: 'Web sitesi analiz edilemedi.', payment: 'Ödeme sunucusuna bağlanılamadı.', licenseInvalid: 'Pro lisansınız doğrulanamadı. Tekrar deneyin veya destekle iletişime geçin.' };
localized.es.errors = { freeScan: 'Se produjo un error durante el análisis.', premiumScan: 'El análisis premium falló.', scanFailed: 'No se pudo analizar el sitio web.', payment: 'No se pudo conectar con el servidor de pagos.', licenseInvalid: 'No se pudo verificar tu licencia Pro. Inténtalo de nuevo o contacta con soporte.' };
localized.fr.errors = { freeScan: 'Une erreur est survenue pendant l’analyse.', premiumScan: 'L’analyse premium a échoué.', scanFailed: 'Impossible d’analyser le site web.', payment: 'Impossible de joindre le serveur de paiement.', licenseInvalid: 'Votre licence Pro n’a pas pu être vérifiée. Réessayez ou contactez le support.' };
localized.ar.errors = { freeScan: 'حدث خطأ أثناء التحليل.', premiumScan: 'فشل التحليل المميز.', scanFailed: 'تعذر تحليل الموقع.', payment: 'تعذر الاتصال بخادم الدفع.', licenseInvalid: 'تعذر التحقق من ترخيص Pro. حاول مرة أخرى أو تواصل مع الدعم.' };
...
localized.sv.dashboard = { ...localized.sv.dashboard, solutionLocked: 'Lösning låst', lockedHint: 'Lås upp ett kompakt JSON-kommando till din AI-agent som bara fixar just det här problemet.', unlockCta: 'Lås upp – €10,99', codeExample: 'AI JSON-kommando', copyCode: 'Kopiera JSON' };
